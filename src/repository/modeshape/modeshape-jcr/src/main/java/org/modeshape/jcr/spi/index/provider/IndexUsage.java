...
public class IndexUsage {
    ...
    public boolean indexAppliesTo( JoinCondition condition ) {
        ...
        if (condition instanceof ParentNodeJoinCondition) {
            return indexAppliesTo((ParentNodeJoinCondition)condition);
        }
    ...
    protected boolean indexAppliesTo( ParentNodeJoinCondition condition ) {
        // By default indexes can't really do anything with this ...
        return false;
    }
