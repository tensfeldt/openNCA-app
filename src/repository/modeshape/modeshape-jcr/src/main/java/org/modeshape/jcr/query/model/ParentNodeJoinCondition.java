 ...
 *
 * javax.jcr.query.qom.ParentNodeJoinCondition
 */
@Immutable
public class ParentNodeJoinCondition implements JoinCondition, javax.jcr.query.qom.ChildNodeJoinCondition {
     ...
     */
    public ParentNodeJoinCondition( SelectorName childSelectorName,
    ...
    public boolean equals( Object obj ) {
        ...
        if (obj instanceof ParentNodeJoinCondition) {
            ParentNodeJoinCondition that = (ParentNodeJoinCondition)obj;
