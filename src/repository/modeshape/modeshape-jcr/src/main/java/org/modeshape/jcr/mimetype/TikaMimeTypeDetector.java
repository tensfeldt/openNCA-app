...
public abstract class TikaMimeTypeDetector implements MimeTypeDetector {
    ...
    public String mimeTypeOf( final String name,
        ...
        if (binaryValue == null) {
            logger.info(null, "binaryValue is null");
            returnValue =  name == null ? null : detect(null, metadata);
        } else {
            ...
            returnValue =  detect(stream, metadata);
        }
        logger.info(null, "returnValue: " + returnValue);
        return returnValue;
    }
