...
public final class PseudoColumns {
    ...
    public static final class Name {
        ...
        public static final String JCR_PARENT = "jcr:parent";   // WPH - Added
        public static final String JCR_PARENT_PATH = "jcr:parentPath";   // WPH - Added
    }
    ...
    public static final class QualifiedName {
        ...
        public static final org.modeshape.jcr.value.Name JCR_PARENT = JcrLexicon.PARENT;    // WPH -Added
        public static final org.modeshape.jcr.value.Name JCR_PARENT_PATH = JcrLexicon.PARENT_PATH;    // WPH -Added
    }
    ...
    public static final class Type {
        ...
        public static final int JCR_PARENT = PropertyType.STRING;   // WPH - Added
        public static final int JCR_PARENT_PATH = PropertyType.STRING;   // WPH - Added
    }
    ...
    static {
        ...
        infos.put(QualifiedName.JCR_PARENT, new Info(Name.JCR_PARENT, QualifiedName.JCR_PARENT, Type.JCR_PARENT));
        infos.put(QualifiedName.JCR_PARENT_PATH, new Info(Name.JCR_PARENT_PATH, QualifiedName.JCR_PARENT_PATH, Type.JCR_PARENT_PATH));
        Map<org.modeshape.jcr.value.Name, Info> infosWithoutUuid = new HashMap<>(infos);
        infosWithoutUuid.remove(QualifiedName.JCR_UUID);
        infosWithoutUuid.remove(QualifiedName.JCR_PARENT);
    ...
    public static boolean isParent( String columnName ) {
        return Name.JCR_PARENT.equals(columnName);
    }

    public static boolean isParent( org.modeshape.jcr.value.Name columnName ) {
        return QualifiedName.JCR_PARENT.equals(columnName);
    }

    public static boolean isParentPath( String columnName ) {
        return Name.JCR_PARENT_PATH.equals(columnName);
    }

    public static boolean isParentPath( org.modeshape.jcr.value.Name columnName ) {
        return QualifiedName.JCR_PARENT_PATH.equals(columnName);
    }
