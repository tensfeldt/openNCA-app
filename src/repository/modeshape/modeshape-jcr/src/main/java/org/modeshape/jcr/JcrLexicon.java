...
public class JcrLexicon {
    ...
    public static final Name PARENT = new BasicName(Namespace.URI, "parent");   // WPH - Added 
    public static final Name PARENT_PATH = new BasicName(Namespace.URI, "parentPath");   // WPH - Added 
