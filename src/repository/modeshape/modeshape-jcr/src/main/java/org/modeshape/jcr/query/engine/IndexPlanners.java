...
// import org.modeshape.jcr.query.model.NodeType;
...
public abstract class IndexPlanners {
    ...
    public static final String NODE_BY_TYPE_INDEX_NAME = "NodeByType";  // WPH - Added
    ...
    public static final String PARENT_BY_PATH_INDEX_NAME = "ParentByPath";  // WPH - Added
    public static final String PATH_PARAMETER = "path";
    public static final String ID_PARAMETER = "id";
    public static final String TYPE_PARAMETER = "type"; // WPH - Added
    ...
    private static class StandardIndexPlanner extends IndexPlanner {
        ...
        public void applyIndexes( QueryContext context,
            ...
            for (javax.jcr.query.qom.Constraint constraint : calculator.andedConstraints()) {
                if (constraint instanceof SameNode) {
                ...
                } else if (constraint instanceof ParentNode) {  // WPH - Added
                    ParentNode parentNode = (ParentNode)constraint;
                    String path = parentNode.getChildPath();
                    calculator.addIndex(PARENT_BY_PATH_INDEX_NAME, null, null, singletonList(constraint), 10, 100L, -1.0f,
                                        PATH_PARAMETER, path);
                    ...
                    // if (leftSide instanceof NodeType) {
                    //     // This is a constraint on the type of a node ...
                    //     StaticOperand rightSide = comparison.getOperand2();
                    //     String type = stringValue(rightSide, context);
                    //     if (type != null) {
                    //         calculator.addIndex(NODE_BY_TYPE_INDEX_NAME, null, null, singletonList(constraint), 1, 1L, -1.0f,
                    //                             TYPE_PARAMETER, type);
                    //     }
                    // }
                    if (leftSide instanceof PropertyValue) {
                        ...
                        // } else if ("jcr:primaryType".equals(propValue.getPropertyName())) {
                        //     // This is a constraint on the ID of a node ...
                        //     StaticOperand rightSide = comparison.getOperand2();
                        //     String type = stringValue(rightSide, context);
                        //     if (type != null) {
