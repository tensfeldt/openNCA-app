...
public interface Visitor {
    ...
    void visit( NodeParent obj );   // WPH - Added

    void visit( NodeParentPath obj );   // WPH - Added
    ...
    void visit( ParentNode obj );

    void visit( ParentNodeJoinCondition obj );
