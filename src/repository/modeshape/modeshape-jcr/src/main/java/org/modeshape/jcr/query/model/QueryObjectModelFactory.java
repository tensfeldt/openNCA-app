...
public class QueryObjectModelFactory implements org.modeshape.jcr.api.query.qom.QueryObjectModelFactory {
    ...
    public ParentNode parentNode( String selectorName,
                                String path ) {
        CheckArg.isNotNull(selectorName, "selectorName");
        CheckArg.isNotNull(path, "path");
        return new ParentNode(selectorName(selectorName), path);
    }

    public ParentNodeJoinCondition parentNodeJoinCondition( String parentSelectorName,
                                                            String childSelectorName ) {
        CheckArg.isNotNull(childSelectorName, "childSelectorName");
        CheckArg.isNotNull(parentSelectorName, "parentSelectorName");
        return new ParentNodeJoinCondition(selectorName(childSelectorName), selectorName(parentSelectorName));
    }
