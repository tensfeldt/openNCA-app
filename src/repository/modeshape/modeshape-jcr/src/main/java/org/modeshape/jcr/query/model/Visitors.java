...
public class Visitors {
    ...
    public static Set<SelectorName> getSelectorsReferencedBy( Visitable visitable ) {
        ...
        visitAll(visitable, new AbstractVisitor() {
            ...
            @Override
            public void visit( NodeParent parent ) {  // WPH -Added
                symbols.add(parent.selectorName());
            }

            @Override
            public void visit( NodeParentPath parentPath ) {  // WPH -Added
                symbols.add(parentPath.selectorName());
            }
            ...
            public void visit( ParentNode parentNode ) {
                symbols.add(parentNode.selectorName());
            }

            @Override
            public void visit( ParentNodeJoinCondition joinCondition ) {
                symbols.add(joinCondition.childSelectorName());
                symbols.add(joinCondition.parentSelectorName());
            }
    ...
    public static class AbstractVisitor implements Visitor {
        ...
        @Override
        public void visit( NodeType obj ) {
        }
        ...
        @Override
        public void visit( NodeParent obj ) {   // WPH - Added
        }

        @Override
        public void visit( NodeParentPath obj ) {   // WPH - Added
        }
        ...
        @Override
        public void visit( ParentNode obj ) {
        }

        @Override
        public void visit( ParentNodeJoinCondition obj ) {
        }
    ...
    public static class WalkAllVisitor extends NavigationVisitor {
        ...
        @Override
        public void visit( NodeType id ) {
            strategy.visit(id);
            visitNext();
        }

        @Override
        public void visit( NodeParent parent ) {
            strategy.visit(parent);
            visitNext();
        }

        @Override
        public void visit( NodeParentPath parentPath ) {
            strategy.visit(parentPath);
            visitNext();
        }
        ...
        @Override
        public void visit( ParentNode parent ) {
            strategy.visit(parent);
            visitNext();
        }
    ...
    public static class ReadableVisitor implements Visitor {
        ...
        @Override
        public void visit( NodeType type ) {
            append(type.selectorName());
        }

        @Override
        public void visit( NodeParent parent ) {
            append("PARENT_ID(").append(parent.selectorName()).append(')');
        }

        @Override
        public void visit( NodeParentPath parentPath ) {
            append("PARENT_PATH(").append(parentPath.selectorName()).append(')');
        }
        ...
        public void visit( ParentNode parent ) {
            append("ISPARENTNODE(");
            append(parent.selectorName());
            append(',');
            append(SINGLE_QUOTE);
            append(parent.getChildPath());
            append(SINGLE_QUOTE);
            append(')');
        }

        @Override
        public void visit( ParentNodeJoinCondition condition ) {
            append("ISPARENTNODE(");
            append(condition.parentSelectorName());
            append(',');
            append(condition.childSelectorName());
