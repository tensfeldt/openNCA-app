...
public final class ModeShapeRestService {
    ...
    @Produces( {MediaType.APPLICATION_JSON, MediaType.TEXT_HTML, MediaType.TEXT_PLAIN} )
    public Response reindex(@Context ServletContext servletContext,
                            @Context HttpServletRequest request,
                            @PathParam( "repositoryName" ) String repositoryName,
                            @PathParam( "workspaceName" ) String workspaceName ) throws RepositoryException {
        return repositoryHandler.reindexRepositoryWorkspace(servletContext, request, repositoryName, workspaceName);
    }
   ...
   /**
    ...
    @POST
    @Path( "{repositoryName}/{workspaceName}/" + RestHelper.CLONE_METHOD_NAME + "{path:.*}" )
    @Produces( {MediaType.APPLICATION_JSON, MediaType.TEXT_PLAIN, MediaType.TEXT_HTML} )
    public Response cloneItem( @Context HttpServletRequest request,
                               @PathParam( "repositoryName" ) String rawRepositoryName,
                               @PathParam( "workspaceName" ) String rawWorkspaceName,
                               @PathParam( "path" ) String path,
                               @QueryParam( "removeExisting" ) @DefaultValue( "false" ) final boolean removeExisting,                              
                               String requestContent ) throws RepositoryException, JSONException {
        return itemHandler.cloneItem(request, rawRepositoryName, rawWorkspaceName, path, removeExisting, requestContent);
    }
