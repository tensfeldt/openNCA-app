...
public class JsonReader {
    ...
    public Document read( InputStream stream,
                          Charset charset,
                          boolean introspectStringValues ) throws ParsingException {
        return read(new BufferedReader(new InputStreamReader(stream, charset)), introspectStringValues);
    }
    ...
    public DocumentSequence readMultiple( InputStream stream,
        ...
        return readMultiple(new BufferedReader(new InputStreamReader(stream, Json.UTF8)), introspectStringValues);
    }
