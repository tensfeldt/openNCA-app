...
public class Operations {
    ...
    public Query build(Constraint constraint, Map<String, Object> variables) {
        // //CHECKSTYLE:OFF
        // System.out.println("constraint is a " + constraint.getClass().getName());
        // //CHECKSTYLE:ON
        ...
        if (constraint instanceof Between) {
            ...
            // //CHECKSTYLE:OFF
            // System.out.println("field: " + field + " low: " + low + " high: " + high);
            // //CHECKSTYLE:ON
        ...
        if (constraint instanceof Comparison) {
            ...
            switch (comp.operator()) {
                ...
                case GREATER_THAN_OR_EQUAL_TO:new RangeQuery(field).lte(value);
        ...
        if (constraint instanceof SetCriteria) {
            ...
            if (setCriteria.getOperand() == null) {
                // WPH - This should not be.
                return null;
            }
            if (operand(setCriteria.getOperand()) == null) {
                // WPH
                return null;
            }
        // //CHECKSTYLE:OFF
        // System.out.println("(constraint instanceof SetCriteria): operand - " + setCriteria.getOperand() + ", values - " +  
        //     setCriteria.getValues() + ", variables - " + variables);
        // //CHECKSTYLE:ON

            String field = (String) operand(setCriteria.getOperand()).apply(setCriteria.getOperand(), variables);

        // //CHECKSTYLE:OFF
        // System.out.println("(constraint instanceof SetCriteria): field - " + field);
        // //CHECKSTYLE:ON
        ...
        // //CHECKSTYLE:OFF
        // System.out.println("(constraint instanceof SetCriteria): vals - " + vals);
        // //CHECKSTYLE:ON
    ...
    private OperandBuilder operand(DynamicOperand op) {
        ...
        // WPH
        if (op instanceof ReferenceValue) {
        ...
        // //CHECKSTYLE:OFF
        // System.out.println("Unexpected op is a " + op.getClass().getName());
        // //CHECKSTYLE:ON
        return null;
    }
    ...
    private final StaticOperandBuilder literalBuilder = new StaticOperandBuilder<Literal>() {
        ...
        public Object apply(String field, Literal op, Map<String, Object> variables) {
            ...
            //CHECKSTYLE:OFF
            // System.out.println("literalBuilder.apply(): this: " + this + " field: " + field + " columns.columns().size(): " + columns.columns().size() + " field: " + field + " op: " + op + " col: "  + col);
            // columns.dump();
            //CHECKSTYLE:ON
    ...
    // WPH
    private final OperandBuilder referenceBuilder = new OperandBuilder<ReferenceValue>() {
        @Override
        public String apply(ReferenceValue op, Map<String, Object> variables) {
            if (op.getPropertyName() != null) {
                return op.getPropertyName();
            } else {
                // we are being asked to query for all the references fields that apply to this index, 
    ...
    /***
    private List<String> collectReferenceFieldNames( ReferenceValue referenceValue ) {
