...
public class EsIndex implements ProvidedIndex {
    ...
    public Results filter(IndexConstraints constraints, long cardinalityEstimate) {
        ...
        //CHECKSTYLE:OFF
        // System.out.println("EsClient.filter() \nquery: " + query.toString());
        // if (!constraints.getConstraints().isEmpty()) {
        //     System.out.println("constraints: " + constraints.getConstraints());
        // }
        // if (!constraints.getVariables().isEmpty()) {
        //     System.out.println("variables: " + constraints.getVariables());
        // }
        //CHECKSTYLE:ON
    ...
    public long estimateCardinality(List<Constraint> constraints, Map<String, Object> variables) {
        ...
        //CHECKSTYLE:OFF
        // System.out.println("EsClient.estimateCardinality() \nquery: " + query.toString());
    ...
    public boolean requiresReindexing() {
        // 2019-04-12 changed from 'return true;' WPH
        try {
            return !client.indexExists(name());
        } catch (IOException e) {
            throw new EsIndexException(e);
        }
    }
