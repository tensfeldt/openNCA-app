...
public class PromotionAdapter extends TypeAdapter<Promotion> {
	...
	public PromotionAdapter(ModeshapeClient msClient) {
		this.msClient = msClient;
	}

	@Override
	public Promotion read(JsonReader reader) throws IOException {
		if (reader.peek() == JsonToken.NULL) {
			reader.nextNull();
			return null;
		}
		Promotion returnValue = new Promotion();
		reader.beginObject();
	...
	@Override
	public void write(JsonWriter writer, Promotion promotion) throws IOException {
