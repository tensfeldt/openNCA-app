...
public class BatchAdapter extends TypeAdapter<Batch> {
	...
	public BatchAdapter(ModeshapeClient msClient) {
		this.msClient = msClient;
	}


	@Override
	public Batch read(JsonReader reader) throws IOException {
	...
	@Override
	public void write(JsonWriter writer, Batch batch) throws IOException {
