...
public class ModeShapeNode {
	...
	public void setChildren(List<ModeShapeNode> children) {
	...
	public static final class CommonProperties {
		...
		public static final String DELETE_FLAG = "equip:deleteFlag";
		public static final String MODIFIED_BY = "equip:modifiedBy";
		public static final String MODIFIED_DATE = "equip:modified";
		public static final String LOCK_FLAG = "equip:lockFlag";
		public static final String LOCKED_BY_USER = "equip:lockedByUser";
		public static final String COMMIT_FLAG = "equip:versionCommitted";
		public static final String SUPERSEDE_FLAG = "equip:versionSuperSeded";
	}
}
...
class EquipDTOMapping {
	...
	public static void init() {
		if (equipMap == null) {
			...
			equipMap.put(DataframeDTO.PRIMARY_TYPE, DataframeDTO.class);
			equipMap.put(MetadatumDTO.PRIMARY_TYPE, MetadatumDTO.class);
			equipMap.put(AssemblyDTO.PRIMARY_TYPE, AssemblyDTO.class);
			equipMap.put(CommentDTO.PRIMARY_TYPE, CommentDTO.class);
			equipMap.put(DatasetDTO.PRIMARY_TYPE, DatasetDTO.class);
			equipMap.put(LibraryReferenceDTO.PRIMARY_TYPE, LibraryReferenceDTO.class);
			equipMap.put(PromotionDTO.PRIMARY_TYPE, PromotionDTO.class);
			equipMap.put(PublishItemDTO.PRIMARY_TYPE, PublishItemDTO.class);
			equipMap.put(PublishStatusChangeDTO.PRIMARY_TYPE, PublishStatusChangeDTO.class);
			equipMap.put(QCChecklistItemDTO.PRIMARY_TYPE, QCChecklistItemDTO.class);
			equipMap.put(QCChecklistSummaryItemDTO.PRIMARY_TYPE, QCChecklistSummaryItemDTO.class);
			equipMap.put(QCRequestDTO.PRIMARY_TYPE, QCRequestDTO.class);
			equipMap.put(QCWorkflowItemDTO.PRIMARY_TYPE, QCWorkflowItemDTO.class);
			equipMap.put(ReportingEventItemDTO.PRIMARY_TYPE, ReportingEventItemDTO.class);
			equipMap.put(ReportingEventStatusChangeDTO.PRIMARY_TYPE, ReportingEventStatusChangeDTO.class);
			equipMap.put(ScriptDTO.PRIMARY_TYPE, ScriptDTO.class);
			equipMap.put(NTFile.PRIMARY_TYPE, NTFile.class);
			equipMap.put(NTResource.PRIMARY_TYPE, NTResource.class);
			equipMap.put(ColumnDTO.PRIMARY_TYPE, ColumnDTO.class);
			equipMap.put(RowDTO.PRIMARY_TYPE, RowDTO.class);
			equipMap.put(AnalysisDTO.PRIMARY_TYPE, AnalysisDTO.class);
			equipMap.put(BatchDTO.PRIMARY_TYPE, BatchDTO.class);
			equipMap.put(LibraryMCTDTO.PRIMARY_TYPE, LibraryMCTDTO.class);
		}
	}
